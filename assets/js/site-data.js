...
window.BAND = {
  ...
  /* Compteurs de votes de la bande (voir SUPABASE.md pour la mise en place).
     Tant que ce n'est pas rempli, les votes restent dans le navigateur du
     visiteur : le site marche, mais rien n'est partagé.
